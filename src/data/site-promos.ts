...
export const SITE_PROMO_CAMPAIGNS: readonly SitePromoCampaign[] = [
  ...
  },
  {
    ...
    body: "No card required. Full analytics, ranking intelligence, and growth insights for your live profile.",
    stat: "No credit card. Cancel anytime before day 30.",
    ctaLabel: "Unlock Pro · 1 month free",
    ctaKind: "open_pro",
    secondaryCtaLabel: "Try Pro free for 30 days",
    secondaryCtaKind: "open_pro",
    dismissible: true,
  },
  {
