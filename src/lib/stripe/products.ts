 ...
 * - PRO+ perks: up to 5 phone videos (45s), client results, and 20% off Boosts.
...
export function productDescription(key: SmoacStripeProductKey): string {
  switch (key) {
    ...
    case "platinum":
      return "Everything in Pro, plus up to 5 profile videos, client results, and 20% off Boosts.";
    case "boosted_profile":
