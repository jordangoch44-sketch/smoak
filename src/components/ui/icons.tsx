...
/** Folded paper map — map recenter control. */
export function FoldedMapIcon({ className = "h-4 w-4" }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function CrownIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M4.5 16.5 6 7.5l4.25 3.5L12 6.75l1.75 4.25L18 7.5l1.5 9H4.5Z" />
      <path d="M5 19.5h14" />
    </svg>
  );
}
