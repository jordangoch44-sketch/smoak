...
export default function TrainerNotFound() {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-6 pt-24 text-center">
      <h1 className="text-4xl font-light text-white">Specialist not found</h1>
      <p className="mt-4 text-silver-400">
        The specialist you&apos;re looking for doesn&apos;t exist or has been
        removed.
      </p>
      <div className="mt-8 flex gap-4">
        <Button href="/explore">Explore Specialists</Button>
        <Link
          href="/"
