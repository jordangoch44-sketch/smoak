...
2. **Day 30** → Free + option to continue **Pro ($19.99/mo)** (Stripe product key: `premium`)
3. **Pro Plus ($29.99/mo)** → everything in Pro, plus client results on the profile and **20% off Boosts** (Stripe product key: `platinum`)
